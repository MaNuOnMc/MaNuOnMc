    ...
    if (messageReaction._emoji.name == "📩") { //Personalizzare l'emoji della reaction
        if (messageReaction.message.channel.id == "1002852468121673779") { //Settare canale
            ...
            server.channels.create(user.username, {
                ...
                canale.setParent("1002860025749983243") //Settare la categoria
                ...
                canale.send("<B> Salve, Descriva il suo PROBLEMA e attenda\nsupporto da uno staff.\nSe non riceve assistenza contatti\nun amministratore in privato.</ b>")
            })
        }
    }
})
